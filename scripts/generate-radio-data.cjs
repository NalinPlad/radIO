...
const STATION_CONFIGS = [
  ...
  { name: "Gutenberg Audiobook Station", identifier: "gutenberg-audiobooks", category: "Literature", shuffle: false },
  { name: "Estación de Hip-Hop", identifier: "spanish-speaking-hip-hop", category: "Music", regex: "mixtape" },
  { name: "Video Game Radio", identifier: "", category: "Music", subject_tags: ["video game music"] },
  { name: "Bobby Loves Jazz", identifier: "vinyl_robert-haber-records", category: "Music" },
  ...
  { name: "Independant Cassette Network", identifier: "noise-arch", category: "Misc" },
  { name: "Naropa Poetry", identifier: "naropa", category: "Literature" },
  { name: "Scanner Radio Broadcast", identifier: "scanner_recordings", category: "Misc", regex: "(LASD|Hamtramck)" },
